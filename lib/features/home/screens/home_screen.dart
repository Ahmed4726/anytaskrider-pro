                            ...
                            return Center(child: Container(
                              ...
                              child: Opacity(
                                ...
                                child: Row(children: [
                                  ...
                                  // Added plus button next to notification with left-only margin
                                  Padding(
                                    ...
                                    child: Transform.translate(
                                      ...
                                      child: InkWell(
                                        child: Container(
                                          ...
                                          child: Transform.translate(
                                            offset: Offset(0, -(scrollingRate * 10)),
                                            child: Icon(Icons.photo_camera, size: 25, color: Theme.of(context).primaryColor),
                                          ),
                                        ),
                                        onTap: () {
                                          debugPrint('PLUS TAP: home_screen -> CustomOrderProducts');
                                          // Navigate directly to widget to avoid any named-route guards
                                          // and ensure a fresh State is created.
                                          Get.to(() => CustomOrderProducts(key: UniqueKey()));
                                        },
                                      ),
                                    ),
                                  ),
