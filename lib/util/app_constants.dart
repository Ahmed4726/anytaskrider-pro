...
class AppConstants {
  ...
  static const String baseUrl = 'https://admin.anytaskrider.com';
  ...
  static const String restaurantReviewUri = '/api/v1/restaurants/reviews';
    ...
    static const String customOrderCreateUri = '/api/v1/customer/custom-order/create';
  static const String customOrderListUri = '/api/v1/customer/custom-order/list';
  static const String customOrderAcceptQuoteUri = '/api/v1/customer/custom-order/accept-quote';
  static const String customOrderRejectQuoteUri = '/api/v1/customer/custom-order/reject-quote';
