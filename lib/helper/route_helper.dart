...
import 'package:stackfood_multivendor/features/product/custom_order_products.dart';
import 'package:stackfood_multivendor/features/product/custom_order_list_screen.dart';
import 'package:stackfood_multivendor/features/product/custom_order_detail_screen.dart';
...
class RouteHelper {
  ...
  static const String customOrderList = '/custom-order-list';
  static const String customOrderDetail = '/custom-order-detail';
  static const String customOrderProducts = '/custom-order';
  ...
  static String getCustomOrderProductsRoute() => customOrderProducts;
  static String getCustomOrderListRoute() => customOrderList;
  static String getCustomOrderDetailRoute(int id) => '$customOrderDetail?id=$id';
  ...
  static List<GetPage> routes = [
      GetPage(name: customOrderProducts, page: () {
      print('ROUTE builder: customOrderProducts');
      return CustomOrderProducts(key: UniqueKey());
    }),
    ...
    GetPage(name: customOrderList, page: () => CustomOrderListScreen()),
    GetPage(name: customOrderDetail, page: () =>  CustomOrderDetailScreen()),
  ];
